...
for n = 6:8
    ...
    data = load([fname 'Pacbio_analysis\all_final4\nuc_prediction\tt\nuc_pred_TTxx_',name,'_73_20.mat']);
    mkdir([fname 'Pacbio_analysis\all_final4\nuc_prediction\heatmaps_pred\pred_HC_cluster_colorc_TTxx_',name,'_mt']);
    mkdir([fname 'Pacbio_analysis\all_final4\nuc_prediction\heatmaps_met\pred_HC_cluster_colorc_TTxx_',name,'_mt']);
    dbstop if error
    mm = 1:169;% select sequences of interest
    ...
    for x = 1:length(mm)
        ...
        print([fname 'Pacbio_analysis\all_final4\nuc_prediction\heatmaps_pred\pred_HC_cluster_colorc_TTxx_',name,'_mt\pred_HC_cluster_mndr_73_20_',name,'_',num2str(m),'.png'],'-dpng','-r300');
        savefig([fname 'Pacbio_analysis\all_final4\nuc_prediction\heatmaps_pred\pred_HC_cluster_colorc_TTxx_',name,'_mt\pred_HC_cluster_mndr_73_20_',name,'_',num2str(m),'.fig']);
        close all force
        ...
        print([fname 'Pacbio_analysis\all_final4\nuc_prediction\heatmaps_met\pred_HC_cluster_colorc_TTxx_',name,'_mt\pred_HC_cluster_mndr_73_20_',name,'_',num2str(m),'_GCmap.png'],'-dpng','-r300');
        savefig([fname 'Pacbio_analysis\all_final4\nuc_prediction\heatmaps_met\pred_HC_cluster_colorc_TTxx_',name,'_mt\pred_HC_cluster_mndr_73_20_',name,'_',num2str(m),'_GCmap.fig']);
        close all force
    end
    toc
end
